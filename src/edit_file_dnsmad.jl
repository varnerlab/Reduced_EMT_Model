...
#
# DN SMAD temoprary
smad_induction_rate = 0.01 # 0.01
smad_deg_rate = 90.0
psmad_deg_rate = 90.0
push!(rate_constant_update_array,[smad_induction_rate_index,smad_induction_rate])
push!(rate_constant_update_array,[psmad_deg_rate_index,psmad_deg_rate])
push!(rate_constant_update_array,[smad_deg_rate_index,smad_deg_rate])
