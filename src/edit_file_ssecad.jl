...
# Ecadherin for real...
push!(rate_constant_update_array,[ecad_virus_forward_rate_index,4.0])
push!(rate_constant_update_array,[ecad_virus_reverse_rate_index,0.1])
...
# ECADHERINchange this to induction rate
#push!(rate_constant_update_array,[ecad_trans_rate_index,ecad_trans_rate*2.0])

# here is the induction rate
#push!(rate_constant_update_array,[ecad_transc_rate_index,4.0])
