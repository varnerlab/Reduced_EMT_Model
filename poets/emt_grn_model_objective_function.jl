...
function SSE_simple(model_values,data_values)
  y = model_values
  m = data_values
  # (max(y)-10)^2
  E = sum((m-y).^2)
...
function SSE(model_values,data_values,Mscale=10)
  y = model_values
  m = data_values
  # (max(y)-10)^2
...
control_parameter_array[17,1]=1.0# SS by AP1 SP1
# activation_SNAIL_SLUG_by_ss_virus: ss_virus induction induction_gene_SNAIL_SLUG
control_parameter_array[18,1]=0.1# SS_VIRUS ***
# # # #
...
# record and lock addition terms
...
#@show MOD
 ...
 #4 EXP SS TGFBab RO LEF ECAD VIM # Fig2E
...
#@show MOD
 #6 EXP SS ECAD RO TGFB3 ECAD VIM # Fig3F
...
#@show MOD
 #9 EXP TGFB3 DNSMAD DNLEF RO ECAD VIM # Fig4G
...
# See if the system remains stable
  ...
  new_parameter_array[len_rca+9]=0.5# GAIN_ecad_virus
  new_parameter_array[len_rca+18]=0.1# GAIN_SS_virus
   # machinery
  ...
  # addition terms
 new_parameter_array[103]=pa103
 new_parameter_array[104]=pa104
 new_parameter_array[105]=pa105
 new_parameter_array[106]=pa106
 new_parameter_array[107]=pa107
 new_parameter_array[108]=pa108
 new_parameter_array[109]=pa109
 new_parameter_array[110]=pa110
 new_parameter_array[111]=pa111
 new_parameter_array[112]=pa112
 new_parameter_array[113]=pa113
 new_parameter_array[114]=pa114
 new_parameter_array[115]=pa115
 new_parameter_array[116]=pa116
